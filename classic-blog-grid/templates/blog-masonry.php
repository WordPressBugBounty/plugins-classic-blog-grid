    ...
    <?php if ($enable_ajax_masonry !== 'disable'): ?>
        <?php if ($query->max_num_pages > 1): ?>
            <div id="load-more-container" style="text-align: center; margin: 20px 0;">
                <button id="load-more" data-page="1" data-max-pages="<?php echo esc_attr($query->max_num_pages); ?>"
                    data-post-id="<?php echo esc_attr(get_the_ID()); ?>" data-show-date="<?php echo esc_attr($show_date); ?>"
                    data-show-author="<?php echo esc_attr($show_author); ?>"
                    data-show-categories="<?php echo esc_attr($show_categories); ?>"
                    data-show-excerpt="<?php echo esc_attr($show_excerpt); ?>" data-show-tags="<?php echo esc_attr($show_tags); ?>"
