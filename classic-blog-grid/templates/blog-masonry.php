        ...
        <div class="masonry-item" <?php if ($enable_featured_image !== 'disable' && has_post_thumbnail()) : ?>
            ...
            <div class="masonry-item-content-wrapper">
                ...
                <div class="clbgd blog-content-box">
                    ...
                    <h2 class="clbgd-masonry-item-title clbgd-blog-post-title2"><?php the_title(); ?></h2>

                    <div class="clbgd-masonry-meta-items">
                        <?php if ($show_date): ?>
                        <p class="clbgd-masonry-item-date clbgd-blog-post-content2">
                            <?php echo esc_html(get_the_date('F j, Y')); ?></p>
                        <?php endif; ?>

                        <?php if ($show_author): ?>
                        <p class="clbgd-masonry-item-author clbgd-blog-post-content2">
                    ...
                    <?php if ($show_categories): ?>
                        <p class="clbgd-masonry-item-category clbgd-blog-post-content2">
                    ...
                    <?php if ($show_excerpt): ?>
                    <p class="clbgd-masonry-item-excerpt clbgd-blog-post-excerpt2">
                    ...
                    <div class="clbgd-blogs-share-comment">
                      ...
                      <p class="clbgd-masonry-item-comments clbgd-blog-post-content2">
