        ...
        <div class="row clbgd-alternate-item <?php echo ($counter % 2 == 0) ? 'left-image' : 'right-image'; ?>">
            <div class=" clbgd-alternate-item-inner">
                ...
                <div class="col-lg-6 col-md-6 clbgd-alternate-content">
                    <h2 class="clbgd-alternate-title clbgd-blog-post-title2">
                        <a class="clbgd-blog-post-content2" href="<?php echo esc_url(get_permalink()); ?>" title="<?php echo esc_attr(get_the_title()); ?>">
                            <?php the_title(); ?>
                        </a>
                    </h2>
                    
                    <div class="clbgd-alternate-excerpt clbgd-blog-post-excerpt2">
                    <?php if ($show_excerpt) : ?>
                    ...
                    <?php if ($show_tags): ?>
                        ...
                        $tags = get_the_tags(); 
                        if ($tags): ?>
                            <p class="clbgd-alternate-tags clbgd-blog-post-content2">
