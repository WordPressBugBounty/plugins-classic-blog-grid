    ...
    <div class="swiper-wrapper">
        ...
        <div class="swiper-slide" data-bg="<?php echo esc_url($clbgd_slide_image); ?>">
            ...
            <div class="clbgd-slide-content">
                ...
                <a href="<?php the_permalink(); ?>"<?php echo $clbgd_link_target; ?> class="clbgd-slide-button clbgd-blog-post-content2 clbgd-button"><?php echo esc_html($clbgd_custom_read_more_text); ?></a>
                <?php endif; ?>
