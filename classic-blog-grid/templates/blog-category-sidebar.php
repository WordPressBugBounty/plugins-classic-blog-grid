...
// Fetch posts based on the selected category (or all posts if no category is selected)
...
<div class="container">
    <div class="clbgd-blog-category-sidebar">
        ...
        <div class="clbgd-sidebar"> <!-- Sidebar for categories -->
        ...
        <div class="clbgd-posts-container"> <!-- Main content area -->
            <?php while ($query->have_posts()) : $query->the_post(); ?>
                <div class="clbgd-post-item">
                    ...
                    <div class="clbgd-post-details">
                        <h3 class="clbgd-blog-post-title2"><a class="clbgd-blog-post-content2" href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h3>
                        <?php if ($show_excerpt): ?>
                    ...
                    <div class="clbgd-alternate-admin-info">
                        <?php if ($show_date): ?>
                            <p class="clbgd-alternate-date clbgd-blog-post-content2"><?php echo esc_html(get_the_date('F j, Y')); ?></p>
                        <?php endif; ?>

                        <?php if ($show_author): ?>
                            <p class="clbgd-alternate-author clbgd-blog-post-content2"><?php echo esc_html__('By', 'classic-blog-grid') . ' ' . esc_html(get_the_author()); ?></p>
                        <?php endif; ?>

                        <?php if ($show_comments): ?>
                            <p class="clbgd-alternate-comments clbgd-blog-post-content2"><?php echo esc_html(get_comments_number()) . ' ' . esc_html__('Comments', 'classic-blog-grid'); ?></p>
                        <?php endif; ?>
                    ...
                    <!-- for show tags  -->
                    <?php if ($show_tags): // Check if tags should be displayed ?>
                        <?php 
                        $tags = get_the_tags(); 
                        if ($tags): ?>
                            <p class="clbgd-blog-post-tags clbgd-blog-post-content2">
		            ...
		            <?php if ($show_social_share): ?>
		        	  <div class="clbgd-social-share-buttons">
		        		  ...
		        		  <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo urlencode(get_permalink()); ?>" target="_blank" rel="noopener noreferrer">
		        			  <i class="fab fa-facebook-f clbgd-blog-post-content2"></i>
		        		  </a>
		        		  <a href="https://twitter.com/intent/tweet?url=<?php echo urlencode(get_permalink()); ?>&text=<?php echo urlencode(get_the_title()); ?>" target="_blank" rel="noopener noreferrer">
		        			  <i class="fab fa-twitter clbgd-blog-post-content2"></i>
		        		  </a>
		        		  <a href="https://www.linkedin.com/shareArticle?mini=true&url=<?php echo urlencode(get_permalink()); ?>&title=<?php echo urlencode(get_the_title()); ?>" target="_blank" rel="noopener noreferrer">
		        			  <i class="fab fa-linkedin-in clbgd-blog-post-content2"></i>
		        		  </a>
		        		  <a href="https://pinterest.com/pin/create/button/?url=<?php echo urlencode(get_permalink()); ?>&media=<?php echo urlencode(get_the_post_thumbnail_url()); ?>&description=<?php echo urlencode(get_the_title()); ?>" target="_blank" rel="noopener noreferrer">
		        			  <i class="fab fa-pinterest-p clbgd-blog-post-content2"></i>
		        		  </a>
		        	  </div>
		          <?php endif; ?>
    ...
    </div> <!-- End category sidebar layout -->
