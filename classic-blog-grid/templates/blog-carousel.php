            ...
            <div class="swiper-slide">
                <div class="clbgd-carousel-item">
                    ...
                    <div class="carousel-content">
                        ...
                        <h2 class="carousel-title clbgd-blog-post-title2"><?php the_title(); ?></h2>
                        <?php if ($show_excerpt) : ?>
                        <p class="carousel-description clbgd-blog-post-excerpt2">
                        ...
                        <div class="clbgd-carousel-meta-fields">
                            ...
                            <?php if ($show_date) : ?>
                            <p class="carousel-date clbgd-blog-post-content2">
                                <?php echo esc_html(get_the_date('F j, Y')); ?></p>
                            <?php endif; ?>
                            <?php if ($show_author) : ?>
                            <p class="carousel-author clbgd-blog-post-content2">
                            ...
                            <p class="clbgd-blog-post-comments clbgd-blog-post-content2">
